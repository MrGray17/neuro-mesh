...
- **Unique WebSocket ports** — Each node binds a different TelemetryBridge port (ALPHA=9000, BRAVO=9010, CHARLIE=9020, DELTA=9030, ECHO=9040, override via `NEURO_WS_PORT` env var) to avoid host-network conflicts.
